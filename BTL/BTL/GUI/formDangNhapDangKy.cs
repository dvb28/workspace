...
namespace BTL
{
    public partial class formDangNhapDangKy : Form
    {
        ...
        GUI.MainForm Home = new GUI.MainForm();
        ...
        {
            thisBtn.Image = new System.Drawing.Bitmap($@"..\..\Img\{imgName}.png");
            ...
            thisLabel.Font = new System.Drawing.Font("Segoe UI", fontSize);
        ...
        private void leaveAnimateChangeloadAnimateChange(BunifuUserControl thisUserControl ,BunifuLabel thisErrorMessage , BunifuTextBox thisBox, BunifuIconButton thisBtn, Label thisLabel, string imgName, string hideImg, string thisColor, int lcX, int lcY, int fontSize, bool isClick)
        {
            ...
            {
                thisLabel.Image = new System.Drawing.Bitmap($@"..\..\Img\{hideImg}.png");
            }
            if(isClick == true)
            {
                if(thisBox.Text == "")
        ...
        private void bunifuIconButton6_MouseHover(object sender, EventArgs e) { ListSocialIcon[0].Image = new System.Drawing.Bitmap(@"..\..\Img\facebook-hover.png"); }
        private void bunifuIconButton6_MouseLeave(object sender, EventArgs e) { ListSocialIcon[0].Image = new System.Drawing.Bitmap(@"..\..\Img\facebook.png"); }
        private void bunifuIconButton7_MouseHover(object sender, EventArgs e) { ListSocialIcon[01].Image = new System.Drawing.Bitmap(@"..\..\Img\instagram-hover.png"); }
        private void bunifuIconButton7_MouseLeave(object sender, EventArgs e) { ListSocialIcon[1].Image = new System.Drawing.Bitmap(@"..\..\Img\instagram.png"); }
        private void bunifuIconButton8_MouseHover(object sender, EventArgs e) { ListSocialIcon[2].Image = new System.Drawing.Bitmap(@"..\..\Img\skype-hover.png"); }
        private void bunifuIconButton8_MouseLeave(object sender, EventArgs e) { ListSocialIcon[2].Image = new System.Drawing.Bitmap(@"..\..\Img\skype.png"); }
        //Sự kiện Click
        ...
        {
            temp++;
            bunifuPictureBox1.Image = new System.Drawing.Bitmap($@"..\..\Img\Bg2.png");
            if(temp == 2)
            {
                bunifuPictureBox1.Image = new System.Drawing.Bitmap($@"..\..\Img\Bg1.png");
                temp = 0;
            }
        ...
        private void showPassword(BunifuTextBox thisBox, BunifuLabel thisBnfLabel)
        {
            ...
            {
                thisBnfLabel.BackgroundImage = new System.Drawing.Bitmap(@"..\..\Img\NoEyes-Fill.png");
                thisBox.UseSystemPasswordChar = false;
                thisBox.PasswordChar = default;
            }
            else if (thisBox.UseSystemPasswordChar == false)
            {
                thisBnfLabel.BackgroundImage = new System.Drawing.Bitmap(@"..\..\Img\Eyes-Fill.png");
        ...
        private void checkUserInfo(string userName, string userPassword)
        {
            if(formActivated == "login")
            {
                ...
                else
                {
                    ...
                    if (ListLoginBoxs[1].Text != userPassword)
                    {
